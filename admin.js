// ==========================================
// پنل ادمین شمعدون - نسخه ۴.۲
// شامل: مقالات، تحلیل‌ها، دستیار AI، صندوق پیام، PDF ساز
// ==========================================
...
// ==========================================
// 📄 ساخت PDF درس (postMessage + localStorage)
// ==========================================
function generateLessonPDF() {
    ...
    // ۱. ذخیره در localStorage (برای fallback)
    try {
        localStorage.setItem('pdfmaker_data', JSON.stringify({
            ...pdfData,
            timestamp: Date.now()
        }));
    } catch (e) {
    ...
    // ۳. ارسال مکرر با postMessage (چون PDF ساز ممکنه دیر لود شه)
    let attempts = 0;
